...
(function($) {
    ...
    $[_PLUGIN_].prototype = {
        ...
        truncate: function() {
            ...
            this.$inner.find('.' + _c.text).each(function() {
                $(this).replaceWith($(this).contents());
            });
            this.$inner.find('.' + _c.keep).removeClass(_c.keep);
...
(function($) {
    ...
    $(window).ready(function() {
      console.log('hdgsjdgjkskjsss')
        ...
        $('.btn-register-newsletter').bind('click', function() {
            $(this).parent().hide();
            $('.form-message').show();
        });
        new WOW().init();
        ...
        $('.box-contact-form .form-control').on('change', function() {
            if ($(this).val() != "") {
                $(this).parents('.form-group').find('label').hide();
            }
        });
        $('.box-contact-form .form-control').focus(function() {
            $(this).parents('.form-group').find('label').hide();
        }).blur(function() {
            if ($(this).val() == "") {
        ...
        $('.close-promotion-modal, .wrapper').click(function() {
    ...
    $.fn.niceSelect = function(method) {
        ...
        function create_nice_select($select) {
            ...
            $options.each(function(i) {
                ...
                $dropdown.find('ul').append($('<li></li>').attr('data-value', $option.val()).attr('data-display', (display || null)).addClass('option' +
